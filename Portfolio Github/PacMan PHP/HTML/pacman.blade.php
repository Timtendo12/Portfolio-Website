...
<head>
    ...
    <script type="text/javascript" src="js/jquerypacman.js"></script>
    ...
    <title>Tim's Speelhal - Pacman</title>
</head>
...
<div id="home">
    <h1>pac-man</h1>
    <h3>Tim Slager<br><em>2020</em></h3>
    <canvas id="canvas-home-title-pacman"></canvas>
    <div id="presentation">
        <div id="presentation-titles">character &nbsp;/&nbsp; nickname</div>
        <canvas id="canvas-presentation-blinky"></canvas><div id="presentation-character-blinky">- Arjan</div><div id="presentation-name-blinky">"Timmerman"</div>
        <canvas id="canvas-presentation-pinky"></canvas><div id="presentation-character-pinky">- Hans</div><div id="presentation-name-pinky">"Kerssies"</div>
        <canvas id="canvas-presentation-inky"></canvas><div id="presentation-character-inky">- Peter</div><div id="presentation-name-inky">"Kral"</div>
        <canvas id="canvas-presentation-clyde"></canvas><div id="presentation-character-clyde">- Merijn</div><div id="presentation-name-clyde">"Keur"</div>
    </div>
